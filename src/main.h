...
static const int LAST_POW_BLOCK = 127851;
...
static const int64_t MAX_MONEY = 5000000000 * COIN; //5b
...
static const int64_t COIN_POW_PREMINE = 4000000000 * COIN; // 4B

static const int64_t POS_START_BLOCK = 1;

static const uint256 hashGenesisBlock("0x00000fd1b9d871b88e181e5b4a223c3aa90b30645ffe2a5a41b488dd25d4d711");
...
extern const std::string RatCoin;
...
public:
    ...
    bool CheckBlock(bool fCheckPOW = true, bool fCheckMerkleRoot = true, bool fCheckSig = true, const CBlockIndex* pindex = NULL) const;
    bool AcceptBlock();
