...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // MainNet:
        const char* pszTimestamp = "RatCoin 3.0 re-infesting March 2023";
        CTransaction txNew;
        txNew.nTime = 1678195674;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1678195674;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 144258 : 0;
	...
	fflush(NULL);
        ...
        assert(block.hashMerkleRoot == uint256("0x72f014550eff970f0012e825887668b373f2af63f5fe47f10b8368d7f54f3d6e"));
